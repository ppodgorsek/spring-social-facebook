...
public interface UserOperations {
	...
	/**
	 * Retrieves the profile for the authenticated user. Only the core fields which don't need any
	 * specific permissions will be fetched.
	 *
	 ...
	 */
	User getUserCoreProfile();

	/**
	 * Retrieves the profile for the specified user. Only the core fields which don't need any
	 * specific permissions will be fetched.
	 *
	 * @param userId
	 *            the Facebook user ID to retrieve profile data for.
	 * @return the user's profile information.
	 * @throws ApiException
	 *             if there is an error while communicating with Facebook.
	 */
	User getUserCoreProfile(String userId);

	/**
	 * Retrieves the profile for the authenticated user.
	 *
	 * @param profileFields
	 *            The fields which need to be fetched, depending on the permissions the application
	 *            has.
	 * @return the user's profile information.
	 * @throws ApiException
	 *             if there is an error while communicating with Facebook.
	 ...
	 *             if FacebookTemplate was not created with an access token.
	 */
	User getUserProfile(String... profileFields);
	 ...
	 *             if there is an error while communicating with Facebook.
	 */
	User getUserProfile(String userId, String... profileFields);
	...
	/**
	 * Retrieves the user's profile image. When height and width are both used, the image will be
	 * scaled as close to the dimensions as possible and then cropped down.
	 *
	 * @param width
	...
	/**
	 * Retrieves a list of permissions that the application has been granted for the authenticated
	 * user.
	 *
	...
	/**
	 * Fetches IDs that the user has on any applications associated with the calling application via
	 * Facebook's Business Mapping API.
	 *
	 ...
	 *
	 * @param query
	 *            the search query (e.g., "Michael Scott")
