...
public class FacebookTemplate extends AbstractOAuth2ApiBinding implements Facebook {
	...
	/**
	 * Set the Graph API version (e.g., "5.0"). If set to null, the version will be left out of the request URLs to the
	 * Graph API.
	 * @param apiVersion the API version. Default is "5.0".
	 */
