...
/**
 * Interface specifying a basic set of operations for interacting with Facebook. Implemented by
 * {@link FacebookTemplate}.
 *
 * @author Craig Walls
 */
public interface Facebook extends GraphApi, ApiBinding {

	String DEFAULT_API_VERSION = "8.0";
	...
	/**
	 * Returns the underlying {@link RestOperations} object allowing for consumption of Facebook
	 * endpoints that may not be otherwise covered by the API binding. The RestOperations object
	 * returned is configured to include an OAuth 2 "Authorization" header on all requests.
	 *
